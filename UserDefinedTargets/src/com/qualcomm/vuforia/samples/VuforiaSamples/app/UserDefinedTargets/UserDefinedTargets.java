...
public class UserDefinedTargets extends Activity implements
	...
	*//**
	...
	private boolean updateBtns = true;
	...
	public void onQCARUpdate(State state) {
		...
		if (refFreeFrame.hasNewTrackableSource()) {
			...
			if (mExtendedTracking && dataSetUserDef.getNumTrackables() > 0) {
				...
				int previousCreatedTrackableIndex = dataSetUserDef
						.getNumTrackables() - 1;
			...
			Trackable trackable = dataSetUserDef.createTrackable(refFreeFrame
	...
	final public static int CMD_BUTTON_RED = 6;
	final public static int CMD_BUTTON_BLUE = 7;
	final public static int CMD_BUTTON_YELLOW = 8;
	final public static int CMD_BUTTON_GREEN = 9;
	...
	public boolean menuProcess(int command) {
		...
		case CMD_EXTENDED_TRACKING:
			...
			if (dataSetUserDef.getNumTrackables() > 0) {
				int lastTrackableCreatedIndex = dataSetUserDef
						.getNumTrackables() - 1;
	...
	private void updateButtons(ImageTracker it) {
		...
		if (updateBtns) {
			...
			DataSet dataSet = it.getActiveDataSet();
			assert (dataSet != null);
